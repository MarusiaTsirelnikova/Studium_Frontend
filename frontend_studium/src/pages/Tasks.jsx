            ...
            <div className="flex flex-col gap-1.25">
              ...
              <div className="flex flex-wrap gap-1.25">
                <div className="relative block">
                    <input type="checkbox" name="technology" id='web' className="peer absolute left-0 -z-1 opacity-0 checked:bg-gray-600" />
                    <label htmlFor='web' className="cursor-pointer px-3 md:px-2.5 py-1.5 rounded-[50px] font-normal text-base inline-block relative mb-0 bg-gray-200 hover:bg-gray-300 peer-checked:bg-white peer-checked:outline-2 peer-checked:outline-green-600">
                      Веб-программирование
                    </label>
                  </div>
                  <div className="relative block">
                    <input type="checkbox" name="technology" id='mobile' className="peer absolute left-0 -z-1 opacity-0 checked:bg-gray-600" />
                    <label htmlFor='mobile' className="cursor-pointer px-3 md:px-2.5 py-1.5 rounded-[50px] font-normal text-base inline-block relative mb-0 bg-gray-200 hover:bg-gray-300 peer-checked:bg-white peer-checked:outline-2 peer-checked:outline-green-600">
                      Мобильная разработка
                    </label>
                  </div>
                  <div className="relative block">
                    <input type="checkbox" name="technology" id='database' className="peer absolute left-0 -z-1 opacity-0 checked:bg-gray-600" />
                    <label htmlFor='database' className="cursor-pointer px-3 md:px-2.5 py-1.5 rounded-[50px] font-normal text-base inline-block relative mb-0 bg-gray-200 hover:bg-gray-300 peer-checked:bg-white peer-checked:outline-2 peer-checked:outline-green-600">
                      Создание БД
                    </label>
                  </div>
              </div>
              ...
              <div className="flex gap-2 flex-wrap">
                {technologies.map((technology, index) => (
                  <div className="relative block">
                    ...
                    <label htmlFor={`technology${index}`} className="cursor-pointer px-3 md:px-2.5 py-1.5 rounded-[50px] font-normal text-base inline-block relative mb-0 bg-gray-200 hover:bg-gray-300 peer-checked:bg-white peer-checked:outline-2 peer-checked:outline-green-600">
                      {technology}
                    </label>
                  </div>
                ))}
